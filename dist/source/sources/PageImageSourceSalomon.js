...
class PageImageSourceSalomon {
    ...
    supports(task) {
        return task.metadata.target_website === 'https://www.salomon.com/en-nl/s?q={{sku_prod}}';
    }
    ...
    async handleCaptchaIfPresent(page) {
    ...
    async solveHoldCaptcha(page, options) {
...
exports.default = PageImageSourceSalomon;
