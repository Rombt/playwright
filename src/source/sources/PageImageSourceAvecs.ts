...
class PageImageSourceAvecs implements ISource<ICollectProductPhotosTask> {
  constructor(
    ...
    ctx.stepParams = new Map([
      [
        CheckSearchResultsStep,
        {
          ...
          emptySelector:
            '.products-search > p:has-text("Немає товарів, що відповідали б критеріям пошуку")',
        },
      ],
      [CheckPageSkuStep, { pageSkuSelector: 'div.[data-model] span.model-copy__value' }],
      [
        SearchGalleryStep,
        {
