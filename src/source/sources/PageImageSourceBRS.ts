...
class PageImageSourceBRS implements ISource<ICollectProductPhotosTask> {
  constructor(
  ...
  async execute(ctx: IExecutionContext<ICollectProductPhotosTask>): Promise<IWorkerResult> {
    ctx.stepParams = new Map([
      ...
      [CheckPageSkuStep, { pageSkuSelector: 'div.product-header__code' }],
      [SearchGalleryStep, { gallerySelector: 'div.gallery__photos' }],
      [
        CollectImgStep,
        {
