...
class PageImageSourceColumbia implements ISource<ICollectProductPhotosTask> {
  constructor(
  ...
  async execute(ctx: IExecutionContext<ICollectProductPhotosTask>): Promise<IWorkerResult> {
    ctx.stepParams = new Map([
      ...
      [CheckPageSkuStep, { pageSkuSelector: `[data-bv-product-id="${ctx.input.normalizedSku}]"` }],
      [SearchGalleryStep, { gallerySelector: '[data-component-id="image-gallery"]' }],
      [
        CollectImgStep,
        {
